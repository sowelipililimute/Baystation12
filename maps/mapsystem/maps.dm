...
/datum/map
	...
	var/list/skybox_background_by_z = list() // Background icon override by Z-level
	var/list/skybox_stars_by_z = list() // Star icon override by Z-level
	var/list/skybox_color_by_z = list() // Background color override by Z-level
